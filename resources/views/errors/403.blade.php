...
@section('title', '403 - Acceso Denegado | SteamWish')

@section('content')
<div class="min-h-[70vh] flex items-center justify-center py-16 px-4">
    <div class="text-center max-w-2xl">
        <div class="mb-8">
            <i data-lucide="shield-off" class="w-24 h-24 mx-auto text-[#0F3A52]"></i>
        </div>
        <h1 class="text-6xl font-bold text-[#0F3A52] mb-4">403</h1>
        <h2 class="text-2xl font-semibold text-[#5DA9D6] mb-6">Acceso Denegado</h2>
        <p class="text-lg text-gray-600 mb-8">
            No tienes permiso para acceder a esta página. Si crees que esto es un error, contacta con el administrador.
        </p>
