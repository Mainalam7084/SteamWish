    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div
                ...
                <div
                    ...
                    <div class="relative z-10 text-center transform -rotate-3">
                        <h2
                            class="text-7xl md:text-[6rem] font-black uppercase text-black drop-shadow-[6px_6px_0_#fff] leading-none">
                            EQUIPO
                        </h2>
                        <div
                            class="inline-block bg-black text-[#FACC15] font-black uppercase px-6 py-2 border-4 border-white mt-4 text-2xl shadow-[6px_6px_0_0_#fff]">
                            STEAMWISH
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full md:w-7/12 p-8 md:p-16 flex flex-col justify-center relative bg-[#0F3A52]">
                    ...
                    <div class="text-xl md:text-3xl font-bold space-y-8 relative z-10 w-full">
                        <p
                            class="inline-block bg-white text-[#0F3A52] p-4 md:p-6 border-4 border-black shadow-[8px_8px_0_0_#FACC15] transform rotate-1">
        ...
        <div class="my-24 w-full">
            <div
                ...
                <div class="w-full md:w-7/12 p-8 md:p-16 flex flex-col justify-center relative bg-[#0F3A52]">
                    ...
                    <div
                        class="absolute top-10 left-10 text-[#1D9E75] opacity-20 text-[180px] font-black pointer-events-none leading-none select-none font-mono">
                        {}
                    </div>

                    <h2
                        class="text-6xl md:text-[5.5rem] font-black uppercase text-[#1D9E75] mb-0 leading-[0.9] tracking-tighter relative z-10 drop-shadow-[4px_4px_0_#000]">
                        DAVID ROLLON
                    </h2>
        ...
        <div class="my-24 w-full">
            <div
                ...
                <div
                    ...
                    <!-- Decorative Badge -->
                    <div
                        class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#FACC15] text-[#7F77DD] font-black uppercase px-6 py-4 border-8 border-black -rotate-12 shadow-[8px_8px_0_0_#000] text-4xl md:text-5xl z-10 pointer-events-none mix-blend-exclusion">
                        UI/UX
                    </div>
                </div>
                ...
                <div class="w-full md:w-7/12 p-8 md:p-16 flex flex-col justify-center relative bg-[#FACC15]">
                    <!-- Background decor graphic -->
                    <div
                        class="absolute -bottom-10 right-0 text-[#7F77DD] opacity-30 text-[250px] font-black pointer-events-none leading-none select-none">
                        @
                    </div>

                    <h2
                        class="text-5xl md:text-6xl font-black uppercase text-black mb-0 leading-[0.9] tracking-tighter relative z-10 drop-shadow-[2px_2px_0_#fff]">
                        GEOVANNY JIMENEZ
                    </h2>
                    ...
                    <div class="text-2xl md:text-3xl font-bold text-black relative z-10 space-y-4">
                        <p
                            class="inline-block bg-[#000] text-[#FACC15] p-4 border-4 border-white shadow-[6px_6px_0_0_#7F77DD]">
        ...
        <div class="my-24 w-full">
            <div
                ...
                <!-- Visual Side -->
                <div
                    class="w-full md:w-5/12 border-b-8 md:border-b-0 md:border-l-8 border-black relative bg-[#1D9E75] flex items-center justify-center p-16 min-h-[350px] overflow-hidden">
                    <!-- Background decor graphic -->
                    <div class="absolute inset-0 flex items-center justify-center opacity-20 pointer-events-none">
                        <span
                            class="text-[350px] font-black text-black leading-none transform -rotate-12 select-none">H</span>
                    </div>
                    <div class="relative z-10 text-center transform rotate-3">
                        <h2
                            class="text-5xl md:text-[6rem] font-black uppercase text-white drop-shadow-[6px_6px_0_#000] leading-none">
                            2026
                        </h2>
                        <div
                            class="inline-block bg-black text-[#FACC15] font-black uppercase px-6 py-2 border-4 border-white mt-4 text-2xl shadow-[6px_6px_0_0_#fff]">
                ...
                <div class="w-full md:w-7/12 p-8 md:p-16 flex flex-col justify-center relative bg-[#0F3A52]">
                    <h2
                        class="text-5xl md:text-6xl font-black uppercase text-[#FACC15] mb-10 leading-tight tracking-tighter relative z-10 drop-shadow-[2px_2px_0_#000]">
                        Nuestra Historia
                    </h2>

                    <div class="text-xl md:text-3xl font-bold space-y-8 relative z-10 w-full">
                        <p
                            class="inline-block bg-white text-black p-4 md:p-6 border-4 border-black shadow-[8px_8px_0_0_#1D9E75] transform -rotate-1">
                            "Comenzamos como un proyecto de fin de grado."
                        </p>
                        <div class="mt-8">
                            <p
                                class="inline-block bg-[#FACC15] text-black px-4 py-3 md:px-6 md:py-4 border-4 border-black shadow-[8px_8px_0_0_#1D9E75] transform rotate-1">
